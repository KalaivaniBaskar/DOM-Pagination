...
function currentPage(){ 
   ...
   // console.log(currPage,tableSize,startRow,endRow);
    ...
    if( len != 0)
    page_show.innerHTML = ` Showing ${startRow} to ${endRow} of ${len} results`
    else
...
function pageEvent(e){ 
    ...
    if(b == 'Previous'){ 
        ...
        currPage = currPage < maxPage? currPage+1 : maxPage; 
        currButton = currPage;
    ...
    var prevSel = document.querySelector("#buttons button[class='active']")
   // console.log(prevSel); 
   if(prevSel != null)
